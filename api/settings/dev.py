...
# Set FIREBASE_STORAGE_BUCKET for development
...
# Update the base settings with the environment-specific values
base_settings.SECRET_KEY = SECRET_KEY
base_settings.FIREBASE_STORAGE_BUCKET = FIREBASE_STORAGE_BUCKET
base_settings.FIREBASE_CREDENTIALS_PATH = FIREBASE_CREDENTIALS_PATH
